- 2026-09-19: Review pass over the v0.1.10..v0.1.11 work; five defects fixed before shipping:
  ...
  - Open UX question, deliberately NOT changed: action toasts no longer expire at all (8a36e5b). `MAX_TOASTS` bounds them at 6, but an ignored toast now occupies the corner for the rest of the session.
